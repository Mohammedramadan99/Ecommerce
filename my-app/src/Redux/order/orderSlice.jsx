...
export const createOrder = createAsyncThunk('order/new', async (orderData, thunkAPI) =>
{
    const { rejectWithValue, getState } = thunkAPI
    try
    {
        const newOrder = await orederServices.newOrder(orderData)
...
export const orderSlice = createSlice({
    ...
    reducers: {
        reset: state =>
        {
            ...
            state.newOrder.isSuccess = false
    ...
    extraReducers: builder =>
    {
        builder
            ...
            .addCase(createOrder.rejected, (state, { payload }) =>
            {
                ...
                state.newOrder.message = payload.message
            })
